      ...
      <section className="flex flex-col items-center justify-center mt-10">
        ...
        <main className="flex lg:flex-row flex-col items-center">
                ...
                <Drawer key={index}>
                  <DrawerTrigger asChild>
                    <div className="flex gap-2">
                      <input
                        ...
                        className="w-6"
                      />
                      <h2 className="text-white text-2xl cursor-pointer">
                        {novices.title}
                      </h2>
                    </div>
                  </DrawerTrigger>
                  <DrawerContent>
                    <div className="mx-auto w-full max-w-2xl">
                      ...
                      <div className="ml-4">
                        <div>
                          <h2 className="text-xl font-extrabold">Recommended language</h2>
                          <ul className="flex flex-col ">
                            {novices.tools.map((tool) => (
                              <li key={index} className="opacity-40">
                                <Link passHref href={tool.url}>{tool.lang}</Link>
                              </li>
                            ))}
                          </ul>
                        </div>
                      ...
                      <div className="ml-4 space-y-2 mt-4">
                        <h2 className="text-xl font-extrabold">Visit these resources to learn more :</h2>
                        <ol>
                          {novices.resources.map((resource) => (
                            <li key={index} className="underline opacity-35 hover:opacity-95">
                              <Link passHref href={resource.url}>{resource.name}</Link>
                            </li>
                          ))}
                        </ol>
                      </div>
          ...
          <div>
            ...
            <main className="flex flex-col gap-4 ml-6">
